  ...
  return (
    <footer className="bg-gradient-to-r from-orange-500 to-yellow-400 text-white mt-20">
      <div className="max-w-6xl mx-auto px-6 py-10 grid gap-6 md:grid-cols-3 text-center md:text-left">
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start gap-4">
            <Link href="#" aria-label="Facebook" className="hover:text-yellow-100">
              <Facebook />
            </Link>
            <Link href="#" aria-label="Instagram" className="hover:text-yellow-100">
              <Instagram />
            </Link>
            <Link href="#" aria-label="Twitter" className="hover:text-yellow-100">
              <Twitter />
            </Link>
          </div>
        </div>
      ...
      <div className="bg-orange-600 text-center text-sm py-4">
        &copy; {currentYear} Tarka Express. All rights reserved.
      </div>
    </footer>
  );
}
